...
<html>
	...
	<body>
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between">
			<span class="navbar-text">家得福超市变电站监控系统</span> <span class="navbar-text">温度:<label id="c1">26</label>℃&nbsp;&nbsp;&nbsp;&nbsp;湿度:<label
			id="c2">50</label>%</span>
		</nav>
		<div class="container">
			<br />
			<div class="row">
				<div class="col-md-auto">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-alarm-tab" href="../eleInfo/HistoryInfo">历史记录</a>
						<a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings">设置</a>
					</div>
				</div>
				<div class="col">
					<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="row">
								<div class="col-8">
									<div class="row">
										...
										<div class="col-6">
											<div id="a1" class="card" style="width: 180px">
												<img id="a1_img" class="card-img-top bg-info " src="img/door.png" style="height: 80px"></img>
									...
									<div class="row">
										...
										<div class="col-6">
											<div class="card" style="width: 180px">
												<img id="a3_img" class="card-img-top bg-info " src="img/water.png" style="height: 80px"></img>
												<div class="card-footer text-muted">
													<div class="row justify-content-center ">
										...
										<div class="col-6">
											<div class="card " style="width: 180px">
												<img id="d3_img" class="card-img-top bg-info " src="img/air.png" style="height: 80px"></img>
												<div class="card-footer text-muted">
													<div class="row justify-content-center ">
								...
								<div class="col-md-auto">
									<ul class="list-group">
										...
										<li class="list-group-item">C相电流:<span id="cxA">0</span><span>A</span></li>
										<li class="list-group-item">A相电压:<span id="axV">0</span><span>KV</span></li>
										<li class="list-group-item">B相电压:<span id="bxV">0</span><span>KV</span></li>
										<li class="list-group-item">C相电压:<span id="cxV">0</span><span>KV</span></li>
										<li class="list-group-item">功率因数:<span id="yinshu">0</span></li>
										<li class="list-group-item">A相有功功率:<span id="axyg">0</span></li>
						...
						<div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-alarm-tab">
							<form>
								<div class="form-row">
									<div class="form-check col-md-6 offset-md-3">
										<input id="tem_linkage_enable" class="form-check-input" type="checkbox" value="" id="temLinkageEnable"> <label class="form-check-label" for="temLinkageEnable">
										温度连锁是否可用 </label>
									</div>
								</div>
								<br />
								<div class="input-group col-md-6 offset-md-3">
									...
									<input name="tem_great_value" id="tem_great_value" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
									<div class="input-group-append">
										<span class="input-group-text">℃ </span> <span class="input-group-text">打开风机</span>
									</div>
								</div>
								<br />
								<div class="input-group col-md-6 offset-md-3">
									...
									<input name="tem_less_value" id="tem_less_value" type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
									<div class="input-group-append">
										<span class="input-group-text">℃ </span> <span class="input-group-text">关闭风机</span>
									</div>
								</div>
								<br />
